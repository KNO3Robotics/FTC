 ...
 */
@Program(name = "Auto Blue", enabled = true)
public class AutoNODumpGyroBlue extends AtlasAutonomousProgram {
    ...
    public void main() {
        ...
        while(this.opModeIsActive() && startTime + 4555 > System.currentTimeMillis()) {
            int head = gyroSensor.getHeading();
            telemetry.addData("head", head);
            if(head > 50 && head < 180) {
                drive.drive(0.95, 1);
