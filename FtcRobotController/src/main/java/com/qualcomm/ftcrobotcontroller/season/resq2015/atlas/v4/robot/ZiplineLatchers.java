...
public class ZiplineLatchers extends SubSystem {
    ...
    @Override
    public void handle() {
        boolean leftLatch = robot.gamepad1.dpad_right;
        boolean rightLatch = robot.gamepad1.dpad_left;

        setLeftLatcher(leftLatch ? 0.40 : 0.80);
        setRightLatcher(rightLatch ? 0.60 : 0.02);
    }
    ...
    public void rightLatcherOut() {
        rightLatcher.setPosition(0.65);
    }

    public void rightLatcherIn() {
        rightLatcher.setPosition(0.14);
    }
}
